        ...
        <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-10 space-y-4 sm:space-y-0">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="theme-input rounded-xl pl-10 pr-4 py-2 text-sm w-full sm:w-64"
                    />
                </div>
            </div>
            ...
            {isLoading ? (
                <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
                    ...
                    <p className="text-secondary font-medium animate-pulse">Chargement de vos trésors...</p>
                </div>
            ) : isError ? (
                ...
                <div className="flex flex-col items-center justify-center min-h-[400px] text-muted space-y-4">
